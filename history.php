                ...
                <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item dropdown py-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item py-3" href="#">Transaction History(ट्रांसक्शन हिस्ट्री )</a></li>
                        </ul>
                    </li>
                    <li class="nav-item py-3">
...
<class class="welcome">
        <h2>
            <img src="logos/t1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History(ट्रांसक्शन हिस्ट्री )</strong> <img
