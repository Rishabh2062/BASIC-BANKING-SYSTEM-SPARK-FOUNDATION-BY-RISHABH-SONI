                ...
                <ul class="navbar-nav me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item dropdown py-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item py-3" href="#">Money Transfer(मनी ट्रांसफर)</a></li>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/m1.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer(मनी ट्रांसफर)</strong> <img src="logos/m2.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color : black;">
                                    ...
                                    <td><a href="users.php?id= <?php echo $rows['id']; ?>"> <button class="btn btn-outline-dark btn">TRANSACT HERE</button></a></td>
                                </tr>
                            <?php
                            }
                            ?>
